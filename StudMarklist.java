...
class StudMarklist
{
  ...
  public static void main(String[] args)
  {
      ...
      String roll[] = new String[4]; //Array to store the roll number d=for each student.
      int marks_tol[][] = new int[4][4]; //multi dimensional array to hold the marks and totals for each students.
